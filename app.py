...
def predict():
    ...
    try:
        ...
        # Ensemble Prediction
        pred_3 = (
            models["lgb_3"].predict(X_input)[0] +
            models["xgb_3"].predict(X_input)[0] +
            models["rf_3"].predict(X_input)[0]
        ) / 3

        pred_7 = (
            models["lgb_7"].predict(X_input)[0] +
            models["xgb_7"].predict(X_input)[0] +
            models["rf_7"].predict(X_input)[0]
        ) / 3
